...
if(CPACK_GENERATOR MATCHES "NSIS")
  ...
  set(CPACK_NSIS_MUI_ICON "/root/pakages/copy/cryptdb/cmake-3.24.2/Utilities/Release\\CMakeLogo.ico")
  set(CPACK_NSIS_MUI_UNIICON "/root/pakages/copy/cryptdb/cmake-3.24.2/Utilities/Release\\CMakeLogo.ico")
  # set the package header icon for MUI
  set(CPACK_PACKAGE_ICON "/root/pakages/copy/cryptdb/cmake-3.24.2/Utilities/Release\\CMakeInstall.bmp")
  # tell cpack to create links to the doc files
  set(CPACK_NSIS_MENU_LINKS
    "doc/cmake-3.24/html/index.html" "CMake Documentation"
    "https://cmake.org" "CMake Web Site"
    )
  # Use the icon from cmake-gui for add-remove programs
  set(CPACK_NSIS_INSTALLED_ICON_NAME "bin\\cmake-gui.exe")

  set(CPACK_NSIS_PACKAGE_NAME "CMake 3.24.2")
  set(CPACK_NSIS_DISPLAY_NAME "CMake 3.24.2, a cross-platform, open-source build system")
...
include("/root/pakages/copy/cryptdb/cmake-3.24.2/Source/QtDialog/QtDialogCPack.cmake" OPTIONAL)
...
if(CPACK_GENERATOR MATCHES "IFW")
  ...
  set(CPACK_IFW_PACKAGE_WINDOW_ICON
    "/root/pakages/copy/cryptdb/cmake-3.24.2/Source/QtDialog/CMakeSetup128.png")
  set(CPACK_IFW_PACKAGE_CONTROL_SCRIPT
    "/root/pakages/copy/cryptdb/cmake-3.24.2/Source/QtIFW/controlscript.qs")
  ...
  set(CPACK_IFW_COMPONENT_GROUP_CMAKE_SCRIPT_TEMPLATE
    "/root/pakages/copy/cryptdb/cmake-3.24.2/Source/QtIFW/installscript.qs.in")
  set(CPACK_IFW_COMPONENT_GROUP_CMAKE_SCRIPT_GENERATED
    "/root/pakages/copy/cryptdb/cmake-3.24.2/CMake.qs")
  set(CPACK_IFW_COMPONENT_GROUP_CMAKE_LICENSES
    "CMake Copyright;/root/pakages/copy/cryptdb/cmake-3.24.2/Copyright.txt")
  ...
  set(CPACK_IFW_COMPONENT_CMAKE-GUI_SCRIPT
    "/root/pakages/copy/cryptdb/cmake-3.24.2/CMake.Dialogs.QtGUI.qs")
  ...
  set(CPACK_IFW_COMPONENT_SPHINX-HTML_SCRIPT
    "/root/pakages/copy/cryptdb/cmake-3.24.2/CMake.Documentation.SphinxHTML.qs")
  ...
  set(CPACK_IFW_COMPONENT_CMAKE-DEVELOPER-REFERENCE-HTML_SCRIPT
    "/root/pakages/copy/cryptdb/cmake-3.24.2/CMake.DeveloperReference.HTML.qs")
...
if("${CPACK_GENERATOR}" STREQUAL "DragNDrop")
  set(CPACK_DMG_BACKGROUND_IMAGE
      "/root/pakages/copy/cryptdb/cmake-3.24.2/Packaging/CMakeDMGBackground.tif")
  set(CPACK_DMG_DS_STORE_SETUP_SCRIPT
      "/root/pakages/copy/cryptdb/cmake-3.24.2/Packaging/CMakeDMGSetup.scpt")
endif()
...
if("${CPACK_GENERATOR}" STREQUAL "WIX")
  ...
  set(CPACK_PACKAGE_FILE_NAME
    "cmake-3.24.2-${CPACK_SYSTEM_NAME}")
  ...
  set(CPACK_WIX_PRODUCT_ICON
    "/root/pakages/copy/cryptdb/cmake-3.24.2/Utilities/Release/CMakeLogo.ico"
  )

  set_property(INSTALL "doc/cmake-3.24/html/index.html" PROPERTY
  ...
  set(CPACK_WIX_UI_BANNER
    "/root/pakages/copy/cryptdb/cmake-3.24.2/Utilities/Release/WiX/ui_banner.jpg"
  )

  set(CPACK_WIX_UI_DIALOG
    "/root/pakages/copy/cryptdb/cmake-3.24.2/Utilities/Release/WiX/ui_dialog.jpg"
  )

  set(CPACK_WIX_EXTRA_SOURCES
    "/root/pakages/copy/cryptdb/cmake-3.24.2/Utilities/Release/WiX/install_dir.wxs"
    "/root/pakages/copy/cryptdb/cmake-3.24.2/Utilities/Release/WiX/cmake_extra_dialog.wxs"
  )

  set(_WIX_CUSTOM_ACTION_ENABLED "FALSE")
  if(_WIX_CUSTOM_ACTION_ENABLED)
    list(APPEND CPACK_WIX_EXTRA_SOURCES
      "/root/pakages/copy/cryptdb/cmake-3.24.2/Utilities/Release/WiX/cmake_nsis_overwrite_dialog.wxs"
      )
    ...
    if(_WIX_CUSTOM_ACTION_MULTI_CONFIG)
      ...
      list(APPEND CPACK_WIX_EXTRA_SOURCES
        "/root/pakages/copy/cryptdb/cmake-3.24.2/Utilities/Release/WiX/custom_action_dll-${_WIX_CUSTOM_ACTION_CONFIG}.wxs")
    else()
      list(APPEND CPACK_WIX_EXTRA_SOURCES
        "/root/pakages/copy/cryptdb/cmake-3.24.2/Utilities/Release/WiX/custom_action_dll.wxs")
    endif()
  endif()
  ...
  set(CPACK_WIX_PATCH_FILE
    "/root/pakages/copy/cryptdb/cmake-3.24.2/Utilities/Release/WiX/patch_path_env.xml"
  )

  set(CPACK_WIX_TEMPLATE
    "/root/pakages/copy/cryptdb/cmake-3.24.2/Utilities/Release/WiX/WIX.template.in"
  )
  ...
  if(BUILD_QtDialog)
    list(APPEND CPACK_WIX_PATCH_FILE
      "/root/pakages/copy/cryptdb/cmake-3.24.2/Utilities/Release/WiX/patch_desktop_shortcut.xml"
      )
